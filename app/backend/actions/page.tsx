...
const stages = [
  {
    ...
    actions: [
      ...
      {
        title: "Enrich",
        description: "Enriches unenriched raw listings with detailed data from the eBay Browse API. Fetches descriptions, images, condition details, and other metadata. Stores enriched responses in raw_listing_details table.",
  ...
  },
  {
    ...
    description: "Transform raw data into structured listings and reconcile with catalog",
    actions: [
      {
        title: "Materialize",
        description: "Transforms raw listings from a capture job into structured listings in the database. Combines search and enrichment data, deduplicates listings, and inserts or updates entries in the listings table.",
      ...
      {
        title: "Reconcile",
        description: "Extracts LEGO set IDs from listing titles and descriptions, validates them against the catalog, and creates join records linking listings to LEGO sets. Queries listings table directly using reconciled_at timestamp.",
  ...
  },
  {
    ...
    description: "Extract attributes and calculate values from listings",
    actions: [
      {
        title: "Analyze",
